		...
		while ($a = mysqli_fetch_assoc($check_fire)) {
			...
			if ($userdbmail == $userenteredmail) {
				...
				try {
					...
					//Content
					$mail->isHTML(true);
					$mail->Subject = 'Email Verification From YasTiwari.com';
					$mail->Body    = '
                              <!DOCTYPE html
					...
					<table style="border-spacing: 0; width: 100%;" width="100%">
						<tr>
							<td style="font-family: "Poppins", sans-serif; text-align: center; padding: 40px 0;" align="center">
								<a href="javascript:void(0)"><img src="	https://www.yastiwari.com/media/Mail/undraw_Opened_re_i38e.png" alt="YasTiwari Logo" title="YasTiwari Logo" style="border: 0; max-width: 300px; width: 90%;"></a>
							</td>
						</tr>
					</table>
				</td>
					...
					<table style="border-spacing: 0; padding: 15px 0; width: max-content; margin: auto;">
						<tr>
							<td style="padding: 0; font-family: "Poppins", sans-serif; text-align: center;" align="center">
								<a href="https://www.yastiwari.com/Verify?userEmail=' . $userdbmail . '&vCode=' . $userVerificationcode . '" style="background-color: #0080ff; color: #ffffff; text-decoration: none; padding: 10px 40px;" title="Verify"> Verify </a>
							</td>
						</tr>
					</table>
				</td>
               ...
               <tr>
				<td style="padding: 0; font-family: "Poppins", sans-serif; background-color: #ffffff; text-align: center;" bgcolor="#ffffff" align="center">
					<table style="border-spacing: 0; padding: 15px 0; width: max-content; margin: auto;">
						<tr>
							<td style="padding: 0; font-family: "Poppins", sans-serif; text-align: center;" align="center">
								<a href="https://www.yastiwari.com/Verify?userEmail=' . $userenteredmail . '&vCode=' . $userVerificationcode . '&enteredNewMail=yes" style="background-color: #0080ff; color: #ffffff; text-decoration: none; padding: 10px 40px;" title="Verify"> Verify </a>
							</td>
						</tr>
					</table>
				</td>
